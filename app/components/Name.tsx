...
import { PiNewspaperClippingBold } from "react-icons/pi"; // Blog icon
        ...
        <Parallax speed={10}>
            ...
            >
                <div className="w-full max-w-4xl flex flex-col justify-center items-center p-4 sm:p-6 lg:p-8">
                    ...
                    <a
                        href="/blog"
                        className="flex items-center gap-2 mt-4 text-blue-600 hover:underline hover:scale-105 transition-transform"
                    >
                        <PiNewspaperClippingBold size={30} />
                        <span className="text-lg font-medium">View Blogs</span>
                    </a>
                </div>
            </motion.div>
        </Parallax>
